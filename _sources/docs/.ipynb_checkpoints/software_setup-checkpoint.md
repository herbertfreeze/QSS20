...
There is a Slack channel for the course, suitable for general questions, Python, and Latex:
    ...
    - `qss20-S26`: logistics, schedule, projects, clarification, due dates, and announcements, and general chat.
